...
default['wordpress']['db']['mysql_version'] = case node['platform']
                                              when 'ubuntu'
...
default['wordpress']['config_perms'] = 0_644
...
default['wordpress']['php_options'] = { 'php_admin_value[upload_max_filesize]' => '50M',
